...
from backend.blog_examples.models import TimestampsOpinionated
from backend.common.factories import RandomModelFactory, SimpleModelFactory
from backend.common.services import model_update
...
class ModelUpdateTests(TestCase):
    ...
    def test_model_update_does_not_automatically_update_updated_at_if_kwarg_is_false(self):
        ...
        with patch("backend.common.services.timezone.now") as now:
            # We will pass created_at, to trigger actual model update
